...
import ru.mixail_akulov.a47_network_retrofit_moshi.app.databinding.ActivityMainBinding
import ru.mixail_akulov.a47_network_retrofit_moshi.app.screens.main.tabs.TabsFragment
import ru.mixail_akulov.a47_network_retrofit_moshi.app.Singletons
import java.util.regex.Pattern

/**
 * Контейнер для всех экранов в приложении.
 */
class MainActivity : AppCompatActivity() {

    // view-model используется для наблюдения за отображением имени пользователя на панели инструментов.
    ...
    // прослушиватель фрагментов подан в суд за отслеживание текущего навигационного контроллера
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // подготовка корневого навигационного контроллера
        ...
        // обновление имени пользователя на панели инструментов
    ...
    private fun prepareTitle(label: CharSequence?, arguments: Bundle?): String {
        ...
        // код этого метода скопирован из источников Google :)
